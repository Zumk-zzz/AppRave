...
Пять наборов подряд: сервер сам по себе (вход, покупка, гонка за последний
билет, двойная бронь стола, оплата, отмена), права ролей, вход по телефону
и почте, заказы теми же вызовами, что делает приложение, и правка каталога
со складом. Все зелёные — система в порядке.
