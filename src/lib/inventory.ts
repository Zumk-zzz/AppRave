...
import type { StockAdjustKind, StockItem, StockMoveKind } from '@/src/services';
...
export const MANUAL_MOVE_KINDS: StockAdjustKind[] = ['receipt', 'writeoff', 'correction'];
...
export function deltaFor(kind: StockAdjustKind, amount: number, currentQty: number): number {
